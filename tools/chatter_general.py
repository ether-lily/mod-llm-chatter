...
def _build_general_response_prompt(
    ...
    if is_rp:
        ...
        style = (
            "Reply like a real 2008 WoW player typing "
            "in General chat — the energy of "
            "Trade chat or a WoW forum/4chan thread in 2008. "
            "Use 2008 internet slang and gamer shorthand "
    ...
    prompt += (
        ...
        f"Rules:\n"
        f"- No quotes, no emojis, no slang from after 2008\n"
        f"- Lean into 2008 internet slang and abbreviations "
        f"naturally — lol, lmao, ur bad, tbh, kek, imo, "
        f"ikr, smh, irl, fml, atm, omg, omfg, fail, "
        f"mfw, tfw, mrw, lel, brb, legit, pleb, normie, "
        f"scrub, owned, pwned, l2p noob, gg, gl hf, "
        f"butthurt, screwed, bs, straight up, rofl, "
        f"cringe, omw, nvm, btw, git gud, noob. Don't "
        f"use them all in one message, but don't hold "
        f"back either — sound like a real 2008 online "
        f"player, an MMO gamer in 2008, not a formal writer. Basic WoW "
