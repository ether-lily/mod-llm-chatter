...
def _build_general_response_prompt(
    ...
    if is_rp:
        ...
        style = (
            ...
            "Trade chat or a WoW subreddit/4chan thread. "
    ...
    prompt += (
        ...
        f"naturally — lol, lmao, ngl, tbh, kek, imo, "
        f"ikr, smh, irl, fml, atm, omg, omfg, cope, "
        ...
        f"closer to Millennial or older gen z\n"
    )
