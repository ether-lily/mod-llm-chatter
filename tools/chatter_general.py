...
def _build_general_response_prompt(
    ...
    if is_rp:
        ...
        style = (
            "Reply like a real 2004-2008 WoW player typing "
            "in General chat — the energy of "
            "Trade chat or a WoW forum/4chan thread. "
    ...
    prompt += (
        ...
        f"- Lean into 2000-2008 internet slang and abbreviations "
        f"naturally — lol, lmao, ur bad, tbh, kek, imo, "
        f"ikr, smh, irl, fml, atm, omg, omfg, fail, "
        f"normie, normalfag, newfag, oldfag, pleb, "
...
def _build_general_followup_prompt(
    ...
    if is_rp:
        ...
        style = (
            ...
            "in General chat — the energy of "
            "Trade chat or a WoW subreddit/WoW 4chan thread. "
            "Use internet slang and gamer shorthand "
            "naturally, throw in a joke or meme "
            "reference if it fits, and don't shy "
            "away from a little snark or friendly "
