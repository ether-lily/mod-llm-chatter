...
def _generate_bot_backstory(
    ...
    prompt = (
        "You write brief profiles for real-life PC gamers "
        "playing World of Warcraft between 2004 and 2008.\n\n"
        f"Player Alias: {bot_name} (plays a {gender_str} {bot_race} {bot_class})\n"
        f"Player Personality: {trait_str}\n"
        f"{tone_line}\n\n"
        "Write a 3-4 sentence real-life background story for the "
        "PERSON behind the keyboard. Include:\n"
        "- Their real-life situation (e.g., high school student "
        "often skipping homework to nolife the game, late-night "
        "college student, bored office worker, stay-at-home "
        "parent, night-shift worker, shut-in neet).\n"
        "- How they play or their gaming setup/environment "
        "(e.g., playing on a clunky CRT monitor, sharing a PC "
        "with a sibling, blasting 2000s rock on Winamp while grinding, "
        "often running on 3 hours of sleep and caffeine).\n"
        "- Their connection to their guild or group (e.g., IRL "
        "friend from school, met the raid leader in a random dungeon, "
        "leveling with a buddy, recruited off a forum post).\n\n"
        "The story MUST focus entirely on the human player behind "
        "the screen, NOT in-game Warcraft lore. "
        f"Use {'she/her' if bot_gender == 'female' else 'he/him'} "
        "pronouns throughout to refer to the player.\n\n"
        "Respond with ONLY the real-life player backstory paragraph, "
